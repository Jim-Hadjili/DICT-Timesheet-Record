            ...
            <div class="bg-purple-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        <h3 class="text-lg leading-6 font-medium text-white">Overtime Confirmation</h3>
                    </div>
                </div>
            </div>
            <!-- Modal Body -->
            <div class="px-6 py-4">
                <p class="mb-3 font-medium">Are you sure you want to proceed with overtime?</p>
                ...
                <p class="text-sm text-gray-600">When you eventually time out, your overtime will be automatically calculated and added to your total hours for today.</p>
            </div>
            <!-- Modal Footer -->
